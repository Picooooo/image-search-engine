...
def args_parse():
    ...
    parser.add_argument('-i', '--input_database_path', default=r".\data\img_test")
    parser.add_argument('-o', '--output_path', default=r"\data")
    parser.add_argument('-m', '--method', default="color")
